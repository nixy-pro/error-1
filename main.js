...
return {
conversation: 'WhatsApp Bot By Arzz'
}}
}
...
let teksnotif = `*Bot* Berhasil Tersambung Ke Nomor WhatsApp ${Skyzo.user.id.split(":")[0]}`
Skyzo.sendMessage("6287840951374@s.whatsapp.net", {text: teksnotif})
